      ...
      child: RotatedBox(
        ...
        child: ListWheelScrollView.useDelegate(
          ...
          childDelegate: ListWheelChildBuilderDelegate(
                  ...
                  child: Center(
                    child: Padding(
                      ...
                      child: Text(
                        '${index + 1} yr',
                        style: TextStyle(
                          fontSize: provider.selectedAge == index + 1 ? 22 : 16,
                          color: provider.selectedAge == index + 1
                              ? CupertinoColors.white
                              : CupertinoColors.systemGrey,
                          fontWeight: provider.selectedAge == index + 1
                              ? FontWeight.bold
                              : FontWeight.normal,
                        ),
                      ),
            ...
            childCount: 200, // Number of items (1 kg to 200 Years)
          ),
        ),
      ),
    );
